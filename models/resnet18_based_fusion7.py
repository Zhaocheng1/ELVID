...
from models.confidence_weighted_fusion7 import ConfidenceWeightedFusion,ConfidenceWeightedFusion1,CrossWeightedFusion,CrossWeightedFusion1,MultiScaleFusionBlock,MultiScaleFusionBlock1,MultiScaleFusionBlock2
# ========== 多尺度局部注意力辅助函数 ==========
...
class MultiViewInteraction(nn.Module):
    ...
    def forward(self, logits_list):
        ...
        return enhanced
###############################backbone###################################
class ModifiedResNet18_fusion7(nn.Module):
...
# -----------------------------------layer4---------------------------------------------------------------------------------
        ...
        fusion_layer4 = self.fusion_weight4(ir_feat=ir_features5__, vis_feat=vis_features5__,  prev_fused_feat=fusion_layer3)
...
if __name__ == "__main__":
   # 初始化模型
    ...
    model = ModifiedResNet18_fusion7(32).to(device)
    #模拟输入 (bs=2, 16帧)
