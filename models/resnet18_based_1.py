...
from models.confidence_weighted_fusion import ConfidenceWeightedFusion,ConfidenceWeightedFusion1
# ========== 多尺度局部注意力辅助函数 ==========
...
class ModifiedResNet18(nn.Module):
 ...
 # -----------------------------------layer0---------------------------------------------------------------------------------
        ...
        fusion_layer1 = self.fusion_weight1(ir_feat=ir_features2__, vis_feat=vis_features2__, conf_ir=conf_ir1,conf_vis=conf_vis1,prev_fused_feat=fusion_layer0)
        ...
        fusion_layer2 = self.fusion_weight2(ir_feat=ir_features3__, vis_feat=vis_features3__, conf_ir=conf_ir2,conf_vis=conf_vis2, prev_fused_feat=fusion_layer1)
 ...
 # -----------------------------------layer3---------------------------------------------------------------------------------
        ...
        fusion_layer3 = self.fusion_weight3(ir_feat=ir_features4__, vis_feat=vis_features4__, conf_ir=conf_ir3, conf_vis=conf_vis3,prev_fused_feat=fusion_layer2)
...
# -----------------------------------layer4---------------------------------------------------------------------------------
        ...
        fusion_layer4 = self.fusion_weight4(ir_feat=ir_features5__, vis_feat=vis_features5__, conf_ir=conf_ir4, conf_vis=conf_vis4, prev_fused_feat=fusion_layer3)
...
if __name__ == "__main__":
   # 初始化模型
    ...
    model = ModifiedResNet18(32).to(device)
    #模拟输入 (bs=2, 16帧)
