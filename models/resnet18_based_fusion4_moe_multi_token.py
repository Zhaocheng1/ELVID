...
from models.Expert_MoE3 import CrossLayerExpertFusion,CrossLayerExpertFusion_MultiGate,CrossLayerExpertFusion_MultiGate_TokenMoE
...
class ModifiedResNet18_fusion(nn.Module):
    def __init__(self,ngf):
        ...
        self.fusion_expertset4 = CrossLayerExpertFusion_MultiGate_TokenMoE(512,512,3)
        # # 冻结所有参数（可选）
